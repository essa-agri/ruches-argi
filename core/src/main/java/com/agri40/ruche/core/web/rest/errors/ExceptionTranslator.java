package com.agri40.ruche.core.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.agri40.ruche.core.service.EmailAlreadyUsedException ||
            ex instanceof com.agri40.ruche.core.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.agri40.ruche.core.service.InvalidPasswordException
