package com.agri40.ruche.core.service.mapper;
...
public class UserMapper {
    ...
    public User userDTOToUser(AdminUserDTO userDTO) {
        if (userDTO == null) {
            ...
            user.setLogin(userDTO.getUsername()); // update
            ...
            user.setDateOfBrith(userDTO.getDateOfBrith());
            return user;
        }
    }
    ...
    public UserDTO toDtoLogin(User user) {
        ...
        UserDTO userDto = new UserDTO();
        userDto.setId(user.getId());
        userDto.setLogin(user.getUsername()); // update
        return userDto;
    }
