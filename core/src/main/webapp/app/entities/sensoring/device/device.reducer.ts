...
import { IDevice, defaultValue } from 'app/shared/model/sensoring/device.model';
...
const apiUrl = 'services/sensoring/api/devices';

// Actions

export const getEntities = createAsyncThunk('device/fetch_entity_list', async ({ sort }: IQueryParams) => {
