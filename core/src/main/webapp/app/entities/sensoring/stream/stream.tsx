...
export const Stream = () => {
  ...
  const streamList = useAppSelector(state => state.core.stream.entities);
  ...
  return (
    <div>
      <h2 id="stream-heading" data-cy="StreamHeading">
        <Translate contentKey="coreApp.sensoringStream.home.title">Streams</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="coreApp.sensoringStream.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/stream/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="coreApp.sensoringStream.home.createLabel">Create new Stream</Translate>
          </Link>
        </div>
      </h2>
        ...
        {streamList && streamList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="coreApp.sensoringStream.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('params')}>
                  ...
                  <FontAwesomeIcon icon={getSortIconByFieldName('params')} />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`/stream/${stream.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                        <FontAwesomeIcon icon="pencil-alt" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.edit">Edit</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`/stream/${stream.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="coreApp.sensoringStream.home.notFound">No Streams found</Translate>
            </div>
          )
        )}
      </div>
