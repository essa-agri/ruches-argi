...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './stream.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STREAM_LIST actions', async () => {
    ...
    it('dispatches FETCH_STREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STREAM actions', async () => {
      const expectedActions = [
        {
