...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rucher.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RUCHER_LIST actions', async () => {
    ...
    it('dispatches FETCH_RUCHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RUCHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RUCHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RUCHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RUCHER actions', async () => {
      const expectedActions = [
        {
