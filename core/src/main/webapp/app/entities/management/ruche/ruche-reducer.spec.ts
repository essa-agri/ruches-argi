...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ruche.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RUCHE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RUCHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RUCHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RUCHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RUCHE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RUCHE actions', async () => {
      const expectedActions = [
        {
